...
sed -i 's/0.5.8/0.5.9/' %{gem_name}.gemspec
sed -i 's/0.5.8/0.5.9/' lib/sensu/spawn.rb
...
%changelog
* Wed Aug 16 2017 Matthias Runge <mrunge@redhat.com> - 2.2.1-2
- relax deps to allow working with rubygem-childprocess 0.5.9
